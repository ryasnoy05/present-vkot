...
audio_restriction_title_claim="Аудиозапись недоступна";
...
global_article_added_to_faves="Статья сохранена в {link}закладках{\/link}";
...
stories_narrative_more="Ещё немного сюжетов";
